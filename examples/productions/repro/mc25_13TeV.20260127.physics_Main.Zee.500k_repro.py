...
#basename        = 'mc25_13TeV.20251215.physics_Main.Zee.500k'
basename         = 'mc25_13TeV.20260127.physics_Main.Zee.500k'
input_path       = f"/mnt/shared/storage03/projects/cern/lorenzetti/{basename}.HIT.Zee.HIT.root"
...
with Flow(name=f"{basename}.r{recon}", path=f"{basepath}/{basename}.r{recon}") as session:
    ...
    input_dataset    = Dataset(name=f"{basename}.HIT.Zee.HIT.root", path=input_path)
