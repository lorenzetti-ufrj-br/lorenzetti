...
basepath         = os.getcwd()
input_path       = f"{basepath}/mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k.jobs.json"
number_of_events = 10
number_of_jobs   = 100
run_number       = 20260108
...
with Flow(name="mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k", path=f"{basepath}/mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k") as session:


    input_dataset    = Dataset(name="mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k.jobs.json", path=input_path)
    ...
    task_1 = Task(name="mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k.EVT",
                  image=image,
                  command=command,
    ...
    task_2 = Task(name="mc25_13TeV.20260108.physics_Main.MB_avgmu1.1k.HIT",
                  image=image,
                  command=command,
